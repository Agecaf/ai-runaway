  ...
  level.mainBullet = (canvas, ctx) => {
    ...
    const b_b_n_1g = (p) => {
      return Bullet.range(30, (i) => {
        return Bullet.range(30, (j) => {

          return b_b_n_1(
            p.rotate(TAU * j / 30 + i).delay(i * 0.3)
            , i % 2 == 0)
    ...
    const b_b_n_2g = (p) => {
      return Bullet.range(30, (i) => {
        return Bullet.range(30, (j) => {
          ...
          return b_b_n_2(
            p.rotate(TAU * j / 30 + Math.floor(i / 8)).delay(i * 0.3)
    ...
    const b_b_n_3g = (p) => {
      return Bullet.range(15, (i) => {
        return Bullet.range(60, (j) => {

          return b_b_n_3(
            p.rotate(TAU * j / 60 + i * 2.4).delay(i * 1)
            , j % 2 == 0)
